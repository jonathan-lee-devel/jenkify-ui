...
export class PasswordService {
  ...
  public sendPasswordResetRequest(email: string): void {
    this.httpClient.post<PasswordResetDto>(`${environment.AUTH_SERVICE_BASE_URL}/password/reset`, {email})
  ...
  confirmPasswordReset(tokenValue: string, password: string, confirmPassword: string) {
    this.httpClient.post<PasswordResetDto>(`${environment.AUTH_SERVICE_BASE_URL}/password/reset/confirm`, {
      tokenValue,
      password,
      confirmPassword,
    })
